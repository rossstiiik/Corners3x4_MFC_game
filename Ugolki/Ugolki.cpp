...
// Ugolki.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CUgolkiApp, CWinApp)
...
// Единственный объект CUgolkiApp

CUgolkiApp theApp;


// Инициализация CUgolkiApp

BOOL CUgolkiApp::InitInstance()
{
